"""Per-account monthly budgets (F4) and period-level fund overrides."""
...
class Budget(Base):
    """A spending limit on one expense account for one calendar month."""

    __tablename__ = "budgets"
    __table_args__ = (
        UniqueConstraint("user_id", "account_id", "year", "month", name="uq_budget_period"),
    )
